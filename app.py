...
def main():
    ...
    html_temp = """
    <div style="background-color:#EA5455 ;padding:10px">
    <h2 style="color:#E4DCCF;text-align:center;">Bengaluru House Price Prediction ML App </h2>
    </div>
    """
    ...
    location = st.selectbox("Location", t)
    sqft = st.number_input("Square Feet")
    bath = st.slider("No. of bathrooms", 1, 16)
    bhk = st.slider("No of BHK", 1, 16)
    if st.button("Predict"):
        output = predict_price(location, sqft, bath, bhk)
        st.success(f"The Estimated Price of this property is: {output}")
